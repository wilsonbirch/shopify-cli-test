...
const developerPreview = {
    ...
    enable: vi.fn(async () => { }),
    disable: vi.fn(async () => { }),
    update: vi.fn(async (_state) => true),
};
describe('Dev', () => {
    test('renders a stream of concurrent outputs from sub-processes, shortcuts and a preview url', async () => {
        ...
        // When
        const renderInstance = render(React.createElement(Dev, { processes: [backendProcess, frontendProcess], abortController: new AbortController(), previewUrl: "https://shopify.com", graphiqlUrl: "https://graphiql.shopify.com", app: testApp, developerPreview: developerPreview }));
    ...
    test("doesn't render shortcuts if the stdin is not a TTY", async () => {
        ...
        // When
        const renderInstance = render(React.createElement(Dev, { processes: [backendProcess, frontendProcess], abortController: new AbortController(), previewUrl: "https://shopify.com", graphiqlUrl: "https://graphiql.shopify.com", app: testApp, developerPreview: developerPreview }), { stdin: new Stdin({ isTTY: false }) });
        await frontendPromise;
        // Then
        expect(unstyled(renderInstance.lastFrame().replace(/\d/g, '0'))).toMatchInlineSnapshot(`
      "00:00:00 │ backend  │ first backend message
    ...
    test('opens the previewUrl when p is pressed', async () => {
        // When
        const renderInstance = render(React.createElement(Dev, { processes: [], abortController: new AbortController(), previewUrl: "https://shopify.com", graphiqlUrl: "https://graphiql.shopify.com", app: testApp, developerPreview: developerPreview }));
    ...
    test('quits when q is pressed', async () => {
        ...
        // When
        const renderInstance = render(React.createElement(Dev, { processes: [], abortController: abortController, previewUrl: "https://shopify.com", graphiqlUrl: "https://graphiql.shopify.com", app: testApp, developerPreview: developerPreview }));
    ...
    test('abortController can be used to exit from outside and should preserve static output', async () => {
        ...
        // When
        const renderInstance = render(React.createElement(Dev, { processes: [backendProcess], abortController: abortController, previewUrl: "https://shopify.com", graphiqlUrl: "https://graphiql.shopify.com", app: testApp, developerPreview: developerPreview }));
        const promise = renderInstance.waitUntilExit();
    ...
    test('accepts inputs when the processes resolve', async () => {
        ...
        // When
        const renderInstance = render(React.createElement(Dev, { processes: [backendProcess], abortController: new AbortController(), previewUrl: "https://shopify.com", graphiqlUrl: "https://graphiql.shopify.com", app: testApp, developerPreview: developerPreview }));
    ...
    test('polls for preview mode', async () => {
        ...
        const renderInstance = render(React.createElement(Dev, { processes: [backendProcess], abortController: new AbortController(), previewUrl: "https://shopify.com", graphiqlUrl: "https://graphiql.shopify.com", app: testApp, pollingTime: 200, developerPreview: developerPreview }));
        await backendPromise;
        expect(unstyled(renderInstance.lastFrame()).replace(/\d/g, '0')).toMatchInlineSnapshot(`
      "00:00:00 │ backend │ first backend message
      00:00:00 │ backend │ second backend message
    ...
    test("doesn't poll for preview mode when the app does not support it", async () => {
        ...
        const renderInstance = render(React.createElement(Dev, { processes: [backendProcess], abortController: new AbortController(), previewUrl: "https://shopify.com", graphiqlUrl: "https://graphiql.shopify.com", app: {
            ...
            }, pollingTime: 200, developerPreview: developerPreview }));
        await new Promise((resolve) => setTimeout(resolve, 500));
        expect(unstyled(renderInstance.lastFrame()).replace(/\d/g, '0')).toMatchInlineSnapshot(`
      "00:00:00 │ backend │ first backend message
      00:00:00 │ backend │ second backend message
